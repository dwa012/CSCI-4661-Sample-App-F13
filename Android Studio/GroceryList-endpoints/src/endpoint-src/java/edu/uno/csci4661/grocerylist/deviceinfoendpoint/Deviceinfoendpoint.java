 ...
 * on 2013-11-18 at 21:59:48 UTC 
 * Modify at your own risk.
 */

package edu.uno.csci4661.grocerylist.deviceinfoendpoint;
...
public class Deviceinfoendpoint extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
    ...
    public class GetDeviceInfo extends DeviceinfoendpointRequest<edu.uno.csci4661.grocerylist.deviceinfoendpoint.model.DeviceInfo> {
        ...
        protected GetDeviceInfo(java.lang.String id) {
            super(Deviceinfoendpoint.this, "GET", REST_PATH, null, edu.uno.csci4661.grocerylist.deviceinfoendpoint.model.DeviceInfo.class);
     ...
     * operation.
     *
     * @param content the {@link edu.uno.csci4661.grocerylist.deviceinfoendpoint.model.DeviceInfo}
     * @return the request
     */
    public InsertDeviceInfo insertDeviceInfo(edu.uno.csci4661.grocerylist.deviceinfoendpoint.model.DeviceInfo content) throws java.io.IOException {
        InsertDeviceInfo result = new InsertDeviceInfo(content);
        initialize(result);
        return result;
    }

    public class InsertDeviceInfo extends DeviceinfoendpointRequest<edu.uno.csci4661.grocerylist.deviceinfoendpoint.model.DeviceInfo> {
         ...
         * @since 1.13
         */
        protected InsertDeviceInfo(edu.uno.csci4661.grocerylist.deviceinfoendpoint.model.DeviceInfo content) {
            super(Deviceinfoendpoint.this, "POST", REST_PATH, content, edu.uno.csci4661.grocerylist.deviceinfoendpoint.model.DeviceInfo.class);
        }
    ...
    public class ListDeviceInfo extends DeviceinfoendpointRequest<edu.uno.csci4661.grocerylist.deviceinfoendpoint.model.CollectionResponseDeviceInfo> {
        ...
        protected ListDeviceInfo() {
            super(Deviceinfoendpoint.this, "GET", REST_PATH, null, edu.uno.csci4661.grocerylist.deviceinfoendpoint.model.CollectionResponseDeviceInfo.class);
        }
    ...
    public class RemoveDeviceInfo extends DeviceinfoendpointRequest<edu.uno.csci4661.grocerylist.deviceinfoendpoint.model.DeviceInfo> {
        ...
        protected RemoveDeviceInfo(java.lang.String id) {
            super(Deviceinfoendpoint.this, "DELETE", REST_PATH, null, edu.uno.csci4661.grocerylist.deviceinfoendpoint.model.DeviceInfo.class);
            this.id = com.google.api.client.util.Preconditions.checkNotNull(id, "Required parameter id must be specified.");
        }
     ...
     * @return the request
     */
    public UpdateDeviceInfo updateDeviceInfo(edu.uno.csci4661.grocerylist.deviceinfoendpoint.model.DeviceInfo content) throws java.io.IOException {
        UpdateDeviceInfo result = new UpdateDeviceInfo(content);
        initialize(result);
        return result;
    }

    public class UpdateDeviceInfo extends DeviceinfoendpointRequest<edu.uno.csci4661.grocerylist.deviceinfoendpoint.model.DeviceInfo> {
         ...
         * @since 1.13
         */
        protected UpdateDeviceInfo(edu.uno.csci4661.grocerylist.deviceinfoendpoint.model.DeviceInfo content) {
            super(Deviceinfoendpoint.this, "PUT", REST_PATH, content, edu.uno.csci4661.grocerylist.deviceinfoendpoint.model.DeviceInfo.class);
        }
